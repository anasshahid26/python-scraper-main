...
if __name__=="__main__":
 ...
 place = ["WA","TX","CA"]
 keyword = ["Dock dealer","Dock Builders","TREDZ decking or Sure Step decking dealers","Deck Builders","Deck Cleaning & Treatment","Dock & Marina dealer","boat lift and dock manufacturer","ShoreMaster","ShoreMaster boat and dock systems","Boat Dealers","boat lift and dock manufacturer","Deck Cleaning & Treatment","titan deck dealer"]
	 ...
	 for keyword_l in range(len(keyword)):
	     for x in range(30):
	         ...
	         if scraped_data:
		         ...
		         with open('%s-Dealers-data.csv'%(place[place_l]),'ab') as csvfile:
 ...
 for place_lL in range(len(place)):
     with open('%s-Dealers-data.csv'%(place[place_l]),'r') as f,open('%s-Dealers-data-No_duplicate.csv'%(place[place_l]),'w') as out_file:
